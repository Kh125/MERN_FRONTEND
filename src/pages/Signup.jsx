        ...
        <div>
            ...
            <form>
              ...
              <div class="flex items-center justify-between mt-8">
                <button
                  type="submit"
                  class="flex items-center justify-center px-3 py-3 border border-transparent text-base font-medium rounded-md text-white bg-custom-dark md:py-4 md:text-lg md:px-10"
                >
                  Register
                </button>
                <Link to="/login" class="font-semibold">Already registered?</Link>
              </div>
            </form>
        </div>
      </div>
