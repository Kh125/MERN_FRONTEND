...
const ScheduleWidget = (props) =>{
    ...
    return <>
        <div className="bg-custom-widget-color mx-2 mb-2 px-4 py-2 h-32 rounded-xl">
            <div className="flex items-center h-28 justify-between">
                ...
                <div className="flex-col">
                    ...
                    <p className="text-lg font-bold text-custom-color text-center">{removeAmPm(schedule.to)}</p>
                </div>
            </div>
        </div>
    </>
