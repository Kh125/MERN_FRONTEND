...
const Weather = () => {
            ...
            navigator.geolocation.getCurrentPosition(
                async (position) => {
                    ...
                    if (
                        ...
                        setCurrentWeather({
                            town: locationData.features[0].properties.geocoding
                                .district,
                            description:
    ...
    return (
        <div>
            <div className="max-w-md mx-auto p-3 font-mono [word-spacing:-5px]">
                {/* Current Weather */}
                <div className="px-6 py-5 mb-2 bg-custom-light-blue rounded-2xl">
                ...
                {/* Hourly Weather */}
                <div className="p-5 mb-2 bg-custom-light-blue rounded-2xl">
                    {skeletonLoading ? (
                        <div>
                ...
                <div className="px-6 py-5 flex items-center bg-custom-light-blue rounded-2xl">
